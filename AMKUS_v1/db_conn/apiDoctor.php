...
function updatePrescription(){
    $pSql="UPDATE `prescription` SET `past_history`='{$_POST['medicalHistory']}',`cheif_complaint`='{$_POST['cheifComplaints']}',`note`='{$_POST['note']}',`refer_to`='{$_POST['referTo']}',`advice`='{$_POST['advice']}',`follow_up`='{$_POST['followUP']}',`status`='prescribed' WHERE `prescription_id`='{$_POST['prescription_id']}' AND `patient_id`='{$_POST['patient_id']}' ";
