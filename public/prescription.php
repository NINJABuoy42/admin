...
<body>
    ...
    <div>
        ...
        <ul>
            <li>
                <div class="row">
                    <div class="col col-sm-6"><strong>Medicine Nomenclature</strong></div>
                    <div class="col col-sm-3"><strong>Dosage</strong></div>
                    <div class="col col-sm-3"><Strong>Duration</Strong></div>
                </div>
            </li>
        </ul>
